...
{
  { Servo(), 27 , "Base", 90}, //blue wire
  { Servo(), 26 , "Shoulder", 90},//green wire
  { Servo(), 25 , "Elbow", 90},//yellow wire
  { Servo(), 33 , "Gripper", 90},//red wire
};
...
<html>
  ...
  <body class="noselect" align="center" style="background-color: white">
    ...
    <h1 style="color: teal;text-align:center;">NEM CORP</h1>
    <h1 style="color: teal;text-align:center;"><strong>NEMBUS Robotic Arm</strong></h1><hr>
    
    <table id="mainTable" style="width:400px;margin:auto;table-layout:fixed" CELLSPACING=10>
      <tr/><tr/>
      <tr/><tr/>
      <tr>
        <td style="color: black ;text-align:left;font-size:25px"><b>Gripper:</b></td>
        <td colspan=2>
      ...
      <tr/><tr/>
      <tr>
        <td style="color: black ;text-align:left;font-size:25px"><b>Elbow:</b></td>
        <td colspan=2>
         <div class="slidecontainer"> 
            <input type="range" min="45" max="110" value="90" class="slider" id="Elbow" oninput='sendButtonInput("Elbow",value)'>
          </div>
        </td>
      </tr> 
      <tr/><tr/>      
      <tr>
        <td style="color: black ;text-align:left;font-size:25px"><b>Shoulder:</b></td> 
        <td colspan=2>
         <div class="slidecontainer"> 
            <input type="range" min="95" max="150" value="90" class="slider" id="Shoulder" oninput='sendButtonInput("Shoulder",value)'>
          </div>
        </td>
      </tr>  
      <tr/><tr/>      
      <tr>
        <td style="color: black ;text-align:left;font-size:25px"><b>Base:</b></td>
        <td colspan=2>
         <div class="slidecontainer">
      ...
      <tr/><tr/> 
      <tr>
        <td style="color: black ;text-align:left;font-size:25px"><b>Record:</b></td>
        <td><input type="button" id="Record" value="OFF" ontouchend='onclickButton(this)'></td>
        <td></td>
      </tr>
      <tr/><tr/> 
      <tr>
        <td style="color: black  ;text-align:left;font-size:25px"><b>Play:</b></td>
